...
config.networkManager.ip = '__internal_vip__';
...
config.imageManager = {};
config.imageManager.ip = '__image_host__';
...
config.computeManager.ip = '__compute_host__';
...
config.identityManager.ip = '__auth_host__';
...
config.storageManager.ip = '__storage_host__';
...
config.cnfg = {};
config.cnfg.server_ip = '__internal_vip__';
...
config.analytics = {};
config.analytics.server_ip = '__internal_vip__';
...
/* Cassandra Server */
config.cassandra = {};
config.cassandra.server_ips = ['__host1_ip__', '__host2_ip__', '__host3_ip__'];
